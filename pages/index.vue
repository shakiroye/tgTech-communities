...
const isSearchResultsEmpty = computed(() => filteredCommunities.value.length === 0)
  ...
  <div>
    <main>
      ...
      <div
        ...
        <CommunityCard :community="community" v-for="(community, index) in filteredCommunities"
                       :key="index"/>
      </div>

      <div v-else class="flex items-center justify-center self-center my-14 mx-auto">
        <p
